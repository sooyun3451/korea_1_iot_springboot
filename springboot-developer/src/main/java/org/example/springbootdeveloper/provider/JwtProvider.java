    ...
    */
    public String generateJwtToken(User user) {
        return Jwts.builder()
                ...
                .compact(); // JWT(를) 최종적으로 직렬화하여 문자열로 반환
    }
    ...
    */
    public String generateEmailValidToken(String username) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + (1000L * 60 * 5))) // 1000ms(1s) * 60 * 5: 현재 시간에 5분을 더해 토큰 만료 시간 설정
