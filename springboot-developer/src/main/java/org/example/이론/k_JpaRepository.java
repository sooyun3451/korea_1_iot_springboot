...
public class k_JpaRepository {
    ...
    // : CRUD, 페이징, 정렬을 포함한 다양한 데이터 엑세스 메서드를 제공
    ...
    // 2. JpaRepository<Type1, Type2>의 구조
    // 1) Type1
    // : 엔티티(Entity) 클래스 타입
    // : DB 테이블과 매핑되는 클래스
    ...
    // : 주로 WHERE, LIKE, BETWEEN, ORDER BY 지원
    ...
    // EX) findByPriceGreaterThan(1000)
